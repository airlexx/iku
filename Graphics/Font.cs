...
public class Font
{
    public static Raylib_cs.Font fontChillaxMedium = Raylib.LoadFontEx("Resources/Fonts/Chillax/Chillax-Medium.ttf", 96, null, 0);

    public static Raylib_cs.Font fontChillaxLight = Raylib.LoadFontEx("Resources/Fonts/Chillax/Chillax-Light.ttf", 96, null, 0);

    public static Raylib_cs.Font fontChillaxBold = Raylib.LoadFontEx("Resources/Fonts/Chillax/Chillax-Bold.ttf", 300, null, 0);
